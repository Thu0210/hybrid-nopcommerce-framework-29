...
public class User_02_BasePage_Static_Method {
    WebDriver driver;
    BasePage basePage;
    ...
    public void User_01_Register() {
        ...
        basePage.sendkeyToElement(driver, "//input[@id='FirstName']", "Le1");
        basePage.sendkeyToElement(driver, "//input[@id='LastName']", "Le1");
        ...
        basePage.sendkeyToElement(driver, "//input[@id='Email']", "lele1231@gmail.com");
