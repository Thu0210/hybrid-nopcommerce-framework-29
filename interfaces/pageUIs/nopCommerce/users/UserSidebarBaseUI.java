...
public class UserSidebarBaseUI {
    ...
    public static final String ORDER_LINK = "xpath=//div[@class='listbox']//a[text()='Orders']";
    public static final String ADDRESS_LINK = "xpath=//div[@class='listbox']//a[text()='Addresses']";
    public static final String DYNAMIC_PAGE_LINK = "xpath=//div[@class='listbox']//a[text()='%s']";
}
